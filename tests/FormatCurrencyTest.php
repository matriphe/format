...
class FormatCurrencyTest extends TestCase
{
    ...
    {
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000));
        $this->assertSame('Rp123.457', $this->format->currency(123456.76));
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000, 'id'));
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000, 'en'));
    ...
    {
        $this->assertSame('-Rp1.000.000', $this->format->currency(-1000000));
        $this->assertSame('-Rp100.000', $this->format->currency(-100000));
        $this->assertSame('-Rp1.000.000', $this->format->currency(-1000000, 'id'));
        $this->assertSame('-Rp100.000', $this->format->currency(-100000, 'ID'));
        $this->assertSame('-Rp1.000.000', $this->format->currency(-1000000, 'en'));
    ...
    {
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000, null, true));
        $this->assertSame('Rp100.000', $this->format->currency(100000, null, true));
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000, 'id', true));
        $this->assertSame('Rp100.000', $this->format->currency(100000, 'ID', true));
        $this->assertSame('Rp1.000.000', $this->format->currency(1000000, 'en', true));
